import { useEffect, useRef, useState } from 'react'; import { Sparkles, Star, Users, ShieldAlert, ListFilter, Download, Info, BookText, Flame, Gift, } from 'lucide-react';
...
<div className="flex gap-2 mb-2 flex-wrap">
    {['ALL', 'XP', 'RELIC', 'FRIEND', 'SYSTEM', 'LORE', 'ACHIEVEMENT', 'GIFT'].map(
      (type) => (
        <button
          key={type}
  ...
  <div className="text-green-400 text-xs mt-2 italic">
